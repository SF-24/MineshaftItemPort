...
public class GetItemTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender commandSender, Command command, String s, String[] args) {
        if(args.length==1) {
            return StringUtil.copyPartialMatches(args[0], Arrays.asList("lotr","teleport_scroll","make_container","xl_food","currency","wand","chocolate_frog_card","hp_food"),new ArrayList<>());
