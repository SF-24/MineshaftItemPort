...
public enum FoodItemXL {
    ...
    MACARONI_AND_CHEESE(Material.SUSPICIOUS_STEW,12, 9, Container.SALAD_BOWL), // IN BOWL

    SPAGHETTI(Material.SUSPICIOUS_STEW,13,9,Container.SALAD_BOWL),
    ...
    GARDEN_SALAD(Material.SUSPICIOUS_STEW, 15, 5, Container.SALAD_BOWL),
    CHICKEN_SALAD(Material.SUSPICIOUS_STEW, 16, 8, Container.SALAD_BOWL),
    CAESAR_SALAD(Material.SUSPICIOUS_STEW, 17, 6, Container.SALAD_BOWL),
    ONION_SALAD(Material.SUSPICIOUS_STEW, 18, 4, Container.SALAD_BOWL),
    TACO_SALAD(Material.SUSPICIOUS_STEW, 19, 10, Container.SALAD_BOWL),

    CUCUMBER_SOUP(Material.SUSPICIOUS_STEW, 20, 6, 0.6f, 1.0f, Container.SALAD_BOWL),
    TOMATO_SOUP(Material.SUSPICIOUS_STEW, 21, 3, 0.6f, 1.0f, Container.SALAD_BOWL),
    VEGETABLE_SOUP(Material.SUSPICIOUS_STEW, 22, 8, 0.6f, 1.0f, Container.SALAD_BOWL),
    CHICKEN_SOUP(Material.SUSPICIOUS_STEW, 23, 10, 0.6f, 1.0f, Container.SALAD_BOWL),
    BEEF_STEW(Material.SUSPICIOUS_STEW, 24, 12, 0.6f, 1.0f, Container.SALAD_BOWL),
    PUMPKIN_STEW(Material.SUSPICIOUS_STEW, 25, 6, 0.6f, 1.0f, Container.SALAD_BOWL),
